...
int main(int argc, char **argv) {
    ...
    model_state_srv_msg.request.model_state.model_name = "cylinder";
    model_state_srv_msg.request.model_state.pose.position.x = 2.5;
    model_state_srv_msg.request.model_state.pose.position.y = 0.0;
    model_state_srv_msg.request.model_state.pose.position.z = 4.0;
