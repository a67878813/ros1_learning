...
public:
    ...
    void setupUi(QWidget *laserVisualization)
    {
        if (laserVisualization->objectName().isEmpty())
            laserVisualization->setObjectName(QStringLiteral("laserVisualization"));
        ...
        laserMean->setObjectName(QStringLiteral("laserMean"));
        ...
        laserMax->setObjectName(QStringLiteral("laserMax"));
        ...
        laserMin->setObjectName(QStringLiteral("laserMin"));
        ...
        laserImage->setObjectName(QStringLiteral("laserImage"));
    ...
    {
        laserVisualization->setWindowTitle(QApplication::translate("laserVisualization", "Form", Q_NULLPTR));
        laserMean->setText(QApplication::translate("laserVisualization", "0 m", Q_NULLPTR));
        laserMax->setText(QApplication::translate("laserVisualization", "0 m", Q_NULLPTR));
        laserMin->setText(QApplication::translate("laserVisualization", "0 m", Q_NULLPTR));
