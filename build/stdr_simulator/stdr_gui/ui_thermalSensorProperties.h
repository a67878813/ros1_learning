...
public:
    ...
    void setupUi(QWidget *ThermalSensorProperties)
    {
        if (ThermalSensorProperties->objectName().isEmpty())
            ThermalSensorProperties->setObjectName(QStringLiteral("ThermalSensorProperties"));
    ...
    {
        ThermalSensorProperties->setWindowTitle(QApplication::translate("ThermalSensorProperties", "Thermal sensor", Q_NULLPTR));
        angleSpan->setText(QApplication::translate("ThermalSensorProperties", "360", Q_NULLPTR));
        maxDistance->setText(QApplication::translate("ThermalSensorProperties", "3.0", Q_NULLPTR));
        y_->setText(QApplication::translate("ThermalSensorProperties", "0.0", Q_NULLPTR));
        x_->setText(QApplication::translate("ThermalSensorProperties", "0.0", Q_NULLPTR));
        label_5->setText(QApplication::translate("ThermalSensorProperties", "Translation - y (m)", Q_NULLPTR));
        label_3->setText(QApplication::translate("ThermalSensorProperties", "Max distance (m)", Q_NULLPTR));
        label_4->setText(QApplication::translate("ThermalSensorProperties", "Translation - x (m)", Q_NULLPTR));
        label_2->setText(QApplication::translate("ThermalSensorProperties", "Angle span (degrees)", Q_NULLPTR));
        label->setText(QApplication::translate("ThermalSensorProperties", "Orientation", Q_NULLPTR));
        label_7->setText(QApplication::translate("ThermalSensorProperties", "Frequency", Q_NULLPTR));
        pushButton->setText(QApplication::translate("ThermalSensorProperties", "Update", Q_NULLPTR));
        refreshButton->setText(QApplication::translate("ThermalSensorProperties", "Refresh", Q_NULLPTR));
    } // retranslateUi
