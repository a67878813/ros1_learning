...
public:
    ...
    void setupUi(QWidget *RfidAntennaProperties)
    {
        if (RfidAntennaProperties->objectName().isEmpty())
            RfidAntennaProperties->setObjectName(QStringLiteral("RfidAntennaProperties"));
        ...
        rfidX->setObjectName(QStringLiteral("rfidX"));
        ...
        rfidOrientation->setObjectName(QStringLiteral("rfidOrientation"));
        ...
        rfidFrequency->setObjectName(QStringLiteral("rfidFrequency"));
        ...
        refreshRfid->setObjectName(QStringLiteral("refreshRfid"));
    ...
    {
        RfidAntennaProperties->setWindowTitle(QApplication::translate("RfidAntennaProperties", "RFID Antenna", Q_NULLPTR));
        rfidY->setText(QApplication::translate("RfidAntennaProperties", "0.0", Q_NULLPTR));
        rfidAngleSpan->setText(QApplication::translate("RfidAntennaProperties", "360", Q_NULLPTR));
        rfidSignalCutoff->setText(QApplication::translate("RfidAntennaProperties", "0.3", Q_NULLPTR));
        rfidMaxDistance->setText(QApplication::translate("RfidAntennaProperties", "3.0", Q_NULLPTR));
        label_6->setText(QApplication::translate("RfidAntennaProperties", "Signal prob. cutoff", Q_NULLPTR));
        rfidX->setText(QApplication::translate("RfidAntennaProperties", "0.0", Q_NULLPTR));
        label_5->setText(QApplication::translate("RfidAntennaProperties", "Translation - y (m)", Q_NULLPTR));
        label_3->setText(QApplication::translate("RfidAntennaProperties", "Max distance (m)", Q_NULLPTR));
        label_4->setText(QApplication::translate("RfidAntennaProperties", "Translation - x (m)", Q_NULLPTR));
        label_2->setText(QApplication::translate("RfidAntennaProperties", "Angle span (degrees)", Q_NULLPTR));
        label->setText(QApplication::translate("RfidAntennaProperties", "Orientation", Q_NULLPTR));
        label_7->setText(QApplication::translate("RfidAntennaProperties", "Frequency", Q_NULLPTR));
        pushButton->setText(QApplication::translate("RfidAntennaProperties", "Update", Q_NULLPTR));
        refreshRfid->setText(QApplication::translate("RfidAntennaProperties", "Refresh", Q_NULLPTR));
    } // retranslateUi
