...
public:
    ...
    void setupUi(QWidget *LaserProperties)
    {
        if (LaserProperties->objectName().isEmpty())
            LaserProperties->setObjectName(QStringLiteral("LaserProperties"));
        ...
        laserTranslationX->setObjectName(QStringLiteral("laserTranslationX"));
        ...
        laserMaxDistance->setObjectName(QStringLiteral("laserMaxDistance"));
        ...
        laserAngleSpan->setObjectName(QStringLiteral("laserAngleSpan"));
        ...
        laserNoiseMean->setObjectName(QStringLiteral("laserNoiseMean"));
        ...
        laserNoiseStd->setObjectName(QStringLiteral("laserNoiseStd"));
        ...
        laserTranslationY->setObjectName(QStringLiteral("laserTranslationY"));
        ...
        laserOrientation->setObjectName(QStringLiteral("laserOrientation"));
        ...
        laserMinDistance->setObjectName(QStringLiteral("laserMinDistance"));
        ...
        laserFrequency->setObjectName(QStringLiteral("laserFrequency"));
        ...
        laserRays->setObjectName(QStringLiteral("laserRays"));
        ...
        laserUpdateButton->setObjectName(QStringLiteral("laserUpdateButton"));
        ...
        refresh_laser->setObjectName(QStringLiteral("refresh_laser"));
    ...
    {
        LaserProperties->setWindowTitle(QApplication::translate("LaserProperties", "Laser", Q_NULLPTR));
        label_3->setText(QApplication::translate("LaserProperties", "Orientation", Q_NULLPTR));
        laserTranslationX->setText(QApplication::translate("LaserProperties", "0.1", Q_NULLPTR));
        label_4->setText(QApplication::translate("LaserProperties", "Angle span (degrees)", Q_NULLPTR));
        laserMaxDistance->setText(QApplication::translate("LaserProperties", "10", Q_NULLPTR));
        label_2->setText(QApplication::translate("LaserProperties", "Max distance (m)", Q_NULLPTR));
        laserAngleSpan->setText(QApplication::translate("LaserProperties", "270", Q_NULLPTR));
        label_5->setText(QApplication::translate("LaserProperties", "Noise - mean (cm)", Q_NULLPTR));
        laserNoiseMean->setText(QApplication::translate("LaserProperties", "0.0", Q_NULLPTR));
        laserNoiseStd->setText(QApplication::translate("LaserProperties", "0.0", Q_NULLPTR));
        label_7->setText(QApplication::translate("LaserProperties", "Translation - x (m)", Q_NULLPTR));
        label_6->setText(QApplication::translate("LaserProperties", "Noise - std (cm)", Q_NULLPTR));
        label_8->setText(QApplication::translate("LaserProperties", "Translation - y (m)", Q_NULLPTR));
        label_9->setText(QApplication::translate("LaserProperties", "Min distance (m)", Q_NULLPTR));
        laserTranslationY->setText(QApplication::translate("LaserProperties", "0.0", Q_NULLPTR));
        laserOrientation->setText(QApplication::translate("LaserProperties", "0", Q_NULLPTR));
        laserMinDistance->setText(QApplication::translate("LaserProperties", "0", Q_NULLPTR));
        label_10->setText(QApplication::translate("LaserProperties", "Frequency (Hz)", Q_NULLPTR));
        laserFrequency->setText(QApplication::translate("LaserProperties", "10", Q_NULLPTR));
        label_11->setText(QApplication::translate("LaserProperties", "Number of rays", Q_NULLPTR));
        laserRays->setText(QApplication::translate("LaserProperties", "270", Q_NULLPTR));
        laserUpdateButton->setText(QApplication::translate("LaserProperties", "Update", Q_NULLPTR));
        refresh_laser->setText(QApplication::translate("LaserProperties", "Refresh", Q_NULLPTR));
    } // retranslateUi
