...
get_filename_component(_filename "/home/ea/ros_ws/src/example_gazebo_set_state/srv/SrvInt.srv" NAME_WE)
add_custom_target(_example_gazebo_set_state_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "example_gazebo_set_state" "/home/ea/ros_ws/src/example_gazebo_set_state/srv/SrvInt.srv" ""
)
...
_generate_srv_cpp(example_gazebo_set_state
  "/home/ea/ros_ws/src/example_gazebo_set_state/srv/SrvInt.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/example_gazebo_set_state)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/example_gazebo_set_state\")")
  # install generated code
  install(
