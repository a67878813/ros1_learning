...
"""autogenerated by genpy from example_action_server/demoActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class demoActionFeedback(genpy.Message):
  _md5sum = "5a6929cb3514eabf286ff2717ef7a5a4"
  _type = "example_action_server/demoActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','example_action_server/demoFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(demoActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = example_action_server.msg.demoFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = example_action_server.msg.demoFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.fdbk,) = _get_struct_i().unpack(str[start:end])
      return self
