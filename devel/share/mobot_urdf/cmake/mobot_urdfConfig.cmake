...
if("TRUE" STREQUAL "TRUE")
  set(mobot_urdf_SOURCE_PREFIX /home/ea/ros_ws/src/mobot_urdf)
  set(mobot_urdf_DEVEL_PREFIX /home/ea/ros_ws/devel)
  ...
  set(mobot_urdf_INSTALL_PREFIX /home/ea/ros_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'mobot_urdf' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'mobot_urdf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ea/ros_ws/src/mobot_urdf/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT mobot_urdf_NUM_DUMMY_TARGETS)
      set(mobot_urdf_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::mobot_urdf::wrapped-linker-option${mobot_urdf_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR mobot_urdf_NUM_DUMMY_TARGETS "${mobot_urdf_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::mobot_urdf::wrapped-linker-option${mobot_urdf_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND mobot_urdf_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${mobot_urdf_dep}_FOUND)
      find_package(${mobot_urdf_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${mobot_urdf_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
