...
(cl:in-package example_ros_msg-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <ExampleServiceMsg-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ExampleServiceMsg-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name example_ros_msg-srv:<ExampleServiceMsg-request> is deprecated: use example_ros_msg-srv:ExampleServiceMsg-request instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <ExampleServiceMsg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader example_ros_msg-srv:name-val is deprecated.  Use example_ros_msg-srv:name instead.")
  (name m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ExampleServiceMsg-request>)))
  ...
  "example_ros_msg/ExampleServiceMsgRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ExampleServiceMsg-request)))
  "Returns string type for a service object of type 'ExampleServiceMsg-request"
  "example_ros_msg/ExampleServiceMsgRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <ExampleServiceMsg-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ExampleServiceMsg-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name example_ros_msg-srv:<ExampleServiceMsg-response> is deprecated: use example_ros_msg-srv:ExampleServiceMsg-response instead.")))

(cl:ensure-generic-function 'on_the_list-val :lambda-list '(m))
(cl:defmethod on_the_list-val ((m <ExampleServiceMsg-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader example_ros_msg-srv:on_the_list-val is deprecated.  Use example_ros_msg-srv:on_the_list instead.")
  (on_the_list m))

(cl:ensure-generic-function 'good_guy-val :lambda-list '(m))
(cl:defmethod good_guy-val ((m <ExampleServiceMsg-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader example_ros_msg-srv:good_guy-val is deprecated.  Use example_ros_msg-srv:good_guy instead.")
  (good_guy m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <ExampleServiceMsg-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader example_ros_msg-srv:age-val is deprecated.  Use example_ros_msg-srv:age instead.")
  (age m))

(cl:ensure-generic-function 'nickname-val :lambda-list '(m))
(cl:defmethod nickname-val ((m <ExampleServiceMsg-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader example_ros_msg-srv:nickname-val is deprecated.  Use example_ros_msg-srv:nickname instead.")
  (nickname m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ExampleServiceMsg-response>)))
  ...
  "example_ros_msg/ExampleServiceMsgResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ExampleServiceMsg-response)))
  "Returns string type for a service object of type 'ExampleServiceMsg-response"
  "example_ros_msg/ExampleServiceMsgResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ExampleServiceMsg)))
  ...
  "example_ros_msg/ExampleServiceMsg")