...
// (in-package example_ros_msg.srv)
...
class ExampleServiceMsgRequest {
  ...
  static datatype() {
    ...
    return 'example_ros_msg/ExampleServiceMsgRequest';
  }
...
class ExampleServiceMsgResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'example_ros_msg/ExampleServiceMsgResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'example_ros_msg/ExampleServiceMsg'; }
};
