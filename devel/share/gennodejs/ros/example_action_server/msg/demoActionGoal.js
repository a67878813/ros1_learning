...
let demoGoal = require('./demoGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class demoActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = demoGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new demoActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = demoGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new demoGoal()
    }
